...
public class QuanShuWangPageProcessorTest implements PageProcessor {
    ...
    public static void main(String[] args) {
        ...
        Spider spider = Spider.create(new QuanShuWangPageProcessorTest()).addUrl("http://www.quanshuwang.com/book/184/184409/54014074.html");
        spider.setScheduler(new QueueScheduler().setDuplicateRemover(new BloomFilterDuplicateRemover(100000000)));
        spider.addPipeline(new FilePipeTest("book"))
                .thread(8)
                .run();
    }
}